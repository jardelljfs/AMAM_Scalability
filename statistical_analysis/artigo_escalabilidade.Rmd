...
## Escalabilidade do FRAMEWORK AMAM

Este plot é referente as valores reais encontrados com as 56 instâncias do problema. 
...
plot(df$quantidade_agente,df$value, col = df$legenda, pch = c(rep(19,10),rep(15,10),rep(17,10)), main = "Numero de agentes x gap(%)", ylab = "gap(%)", xlab = "Quantidade de Agentes", xaxt = 'n');
legend("topright",inset=c(0,-0.1), legend = c("Melhor", "Média", "Mediana"), col=c("black", "red", "green"), pch = c(19,15,17), xpd=TRUE, horiz=TRUE, bty="n")
...
plot(log(df$quantidade_agentes),log(df$value), col = df$legenda, pch = c(rep(19,10),rep(15,10),rep(17,10)), main = "Numero de agentes x gap(%)", ylab = "Log do gap(%)", xlab = "Log da Quantidade de Agentes", xaxt = 'n');
legend("topright",inset=c(0,-0.01), legend = c("Melhor", "Média", "Mediana"), col=c("black", "red", "green"), pch = c(19,15,17), xpd=TRUE, horiz=TRUE, bty="n")
...
g1 <- ggplot(df, aes(x=quantidade_agentes, y=media)) + geom_point() + geom_smooth(method = lm, se = FALSE)
g2 <- ggplot(df, aes(x=quantidade_agentes, y=mediana)) + geom_point() + geom_smooth(method = lm, se = FALSE)
g3 <- ggplot(df, aes(x=quantidade_agentes, y=melhor)) + geom_point() + geom_smooth(method = lm, se = FALSE)

g1 / g2 / g3

t1 <- ggplot(df, aes(x=quantidade_agentes, y=media_time)) + geom_point() + geom_smooth(method = lm, se = FALSE)
t2 <- ggplot(df, aes(x=quantidade_agentes, y=mediana_time)) + geom_point() + geom_smooth(method = lm, se = FALSE)
t3 <- ggplot(df, aes(x=quantidade_agentes, y=melhor_time)) + geom_point() + geom_smooth(method = lm, se = FALSE)
