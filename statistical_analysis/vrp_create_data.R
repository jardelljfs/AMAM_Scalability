...
dados <- read.delim("vrp_data.csv", header = T, sep=",")
...
#write.csv(results, file = "vrp_data.csv", row.names = FALSE)

#results <- read.csv("teste_results.csv", dec = ".", sep="\t")
#write.csv(results, file = "vrp_results.csv", row.names = FALSE)
...
#write.csv(data_fo, file = "vrp_data_fitness.csv", row.names = FALSE)
...
#write.csv(data_time, file = "vrp_data_time.csv", row.names = FALSE)
...
#write.csv(resumo, file = "vrp_summary.csv", row.names = FALSE)