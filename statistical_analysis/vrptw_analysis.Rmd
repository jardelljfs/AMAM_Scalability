...
title("Average gap behavior on a logarithmic scale.")
...
g2 <- ggplot(df, aes(x=quantidade_agentes, y=mediana)) + geom_point() + ggtitle("Median") + ylab("") + xlab("") + geom_smooth(method = lm, se = FALSE)
g3 <- ggplot(df, aes(x=quantidade_agentes, y=melhor)) + geom_point() + ggtitle("Best") + ylab("") + xlab("") + geom_smooth(method = lm, se = FALSE)
...
```{r multiC, echo=FALSE, fig.width=12}
...
### Four situations for the case of the set of instances C.

#### Situation 1 - 1800 x 1800
```{r multiC1, echo=FALSE, fig.width=12}
grid.arrange(t, nrow = 1)
pairwise.t.test(d_60_1800$time, d_60_1800$tratamento, p.adjust.method="bonferroni")
```
#### Situation 2 - 30 x 30
```{r multiC2, echo=FALSE, fig.width=12}
grid.arrange(t2, nrow = 1)
pairwise.t.test(d_1800_30$time, d_1800_30$tratamento, p.adjust.method="bonferroni")
```
#### Situation 3 - 1800 x 30
```{r multiC3, echo=FALSE, fig.width=12}
grid.arrange(t1, nrow = 1)
pairwise.t.test(d_1_30$time, d_1_30$tratamento, paired=T, p.adjust.method="bonferroni")
```
#### Situation 4 - 30 x 60
```{r multiC4, echo=FALSE, fig.width=12}
grid.arrange(t3, nrow = 1)
pairwise.t.test(d_1_30_m$time, d_1_30_m$tratamento, p.adjust.method="bonferroni")
```